            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="${roles == null ? 'role-add' : 'role-edit'}">
					            <input type="hidden" name="id" value="${roles.id}">
                                <div class="form-group">
                                    <label class="col-md-12">Tên quyền</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên quyền" value="${roles.name }" name="name"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Mô tả" class="form-control form-control-line" value="${roles.description }" name="description" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success">${roles == null ? "Add Roles" : "Update Role"}</button>
