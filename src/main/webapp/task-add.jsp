            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="${task == null ? 'task-add' : 'task-edit' }">
                            <input type="hidden" name="id" value="${task.id}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">	
                                        <input type="text" placeholder="Tên công việc" name="name" value="${task.name }"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <c:forEach var="item" items="${listUser}">
                                            <option value="${item.id}" 
                                            		${item.id == task.users.id ? "selected" : ""}>
                                            		${item.fullname}
                                            </option>                                        
                                        </c:forEach>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="dd/MM/yyyy" name="start_date" value="${task.start_date }"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="dd/MM/yyyy" name="end_date" value="${task.end_date }"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
