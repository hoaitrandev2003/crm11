            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="${user == null ? 'user-add' : 'user-edit' }">
                            <input type="hidden" name="id" value="${user.id}">
                                <div class="form-group">
                                    <label class="col-md-12">Full Name</label>
                                    <div class="col-md-12">
                                        <input type="text" name="fullname" placeholder="Johnathan Doe" value="${user.fullname }"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email"  class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <input type="email" name="email" value="${user.email }" placeholder="johnathan@admin.com"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="phone_no" placeholder="123 456 7890" value="${user.phone_no}"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="role">
	                                       <c:forEach var = "item" items="${listAllRoles}">
	                                         <option value="${item.id}"
									            ${item.id == user.role.id ? "selected" : ""}>
									            ${item.name}
									        </option>
									      </c:forEach>
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit"  class="btn btn-success">${user == null ? "Add User" : "Update User"}</button>
