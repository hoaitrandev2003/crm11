                            ...
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                             <td>${item.id}</td>
									        <td>${fn:substringBefore(item.fullname, ' ')}</td>
									        <td>${fn:substringAfter(item.fullname, ' ')}</td>
									        <td>${item.email}</td>
									        <td>${item.role.name}</td>
                                            <td>
                                                <a href="user-edit?id=${item.id }"  class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="user-delete?id=${item.id}" onclick="return confirm('Bạn có chắc muốn xóa?')" class="btn btn-sm btn-danger">Xóa</a>
