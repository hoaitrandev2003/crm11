                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach var="item" items="${listJobs}">
                                        <tr>
                                            ...
                                            <td>${item.end_date}</td>
                                            <td>
                                                <a href="groupwork-edit?id=${item.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="groupwork-delete?id=${item.id}" onclick="return confirm('Bạn có chắc muốn xóa?')" class="btn btn-sm btn-danger">Xóa</a>
